...
children.push(
  ...
  P('**Premissa e título:** a definir (ver 7. Narrativa).', { run: { italics: true } }),
...
children.push(
  ...
  table(['Elemento', 'Descrição', 'Status'], [
    ['Título do jogo', '', '☐ Pendente'],
    ['Premissa (1 parágrafo)', '', '☐ Pendente'],
    ['Tema central', '', '☐ Pendente'],
    ...
    ['Protagonista', '', '☐ Pendente'],
    ['Grupo (6–8 personagens)', '', '☐ Pendente'],
    ['Antagonista principal', '', '☐ Pendente'],
...
children.push(...phase(0, 'Pré-produção',
  ...
  [
    ...
    ['Definir título, premissa e tom', 'Diretor', 'D-01: tom e mundo definidos; falta título e premissa', WIP],
    ...
    ['Esboçar história em atos e o grupo principal', 'Diretor + Claude', ''],
...
children.push(
  ...
  table(['ID', 'Decisão', 'Opções', 'Escolha', 'Data'], [
    ['D-01', 'Título, premissa e tom', '—', 'Tom: mistura equilibrada. Mundo: fantasia clássica + steampunk. Título e premissa: pendentes', today],
...
children.push(
  ...
  table(['Versão', 'Data', 'Alterações'], [
    ...
    ['0.2', today, 'Decisões D-02 a D-09 registradas e D-01 parcial; projeto Godot, Git/GitHub e teste de imagem concluídos; seções de combate, progressão, arte e áudio atualizadas.'],
  ], [12, 18, 70]),
  gap(),
  H2('Próximos passos'),
  N('Definir título e premissa da história (D-01) e esboçar o grupo principal.', 'next'),
