...
children.push(table(
  ['Campo', 'Valor'],
  [
    ['Versão do documento', '1.2 — transições de cena'],
...
children.push(...phase(1, 'Protótipo técnico',
  ...
  [
    ...
    ['Ordem de turnos CTB (versão inicial)', 'Claude', 'Lógica pronta e testada (TurnQueue, DamageFormula); falta a interface', WIP],
