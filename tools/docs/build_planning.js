...
children.push(table(
  ['Campo', 'Valor'],
  [
    ['Versão do documento', '1.3 — primeira batalha'],
...
children.push(...phase(2, 'Sistemas centrais',
  ...
  [
    ['Modelos de dados (Resources): personagem, inimigo, item, habilidade', 'Claude', 'Personagem, inimigo e habilidade prontos (Fase 1); falta item', WIP],
    ...
    ['Sistema de afinidade (romance e finais)', 'Claude', 'H-06'],
