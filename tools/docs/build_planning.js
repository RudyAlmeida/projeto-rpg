...
children.push(
  ...
  table(['ID', 'Arquivo', 'Tipo', 'Fase', 'Status', 'Obs.'], [
    ...
    ['A-030', 'assets/audio/music/bgm_junkyard_a / boss_a / empire_b / farewell_b', 'Música', 'F3', DONE, 'Suno: Ferro-Velho (A), Chefe (A), Tema do Império (B), Adeus (B) — escolhas do Diretor; outras variações guardadas'],
